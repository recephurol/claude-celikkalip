...
function HomePageContent({ products }: { products: any[] }) {
    ...
    <>
      <section className="relative h-[600px] md:h-[700px] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl">
            <Image src="/images/logo.png" alt="Celik Kalip" width={220} height={74} className="h-16 md:h-20 w-auto mb-6 brightness-200" />
            <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-6">
              {t("hero.title1")}<br />
              <span className="text-[var(--color-primary)]">{t("hero.title2")}</span>
            </h1>
            <div className="flex flex-wrap gap-4">
              <Link href="/urunler" className="inline-flex items-center px-8 py-4 bg-[var(--color-primary)] text-white font-semibold rounded-lg hover:bg-[var(--color-primary-dark)] transition-all shadow-lg">
                {t("hero.cta_products")}
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </Link>
              <Link href="/iletisim" className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-[var(--color-text)] transition-all">
                {t("hero.cta_contact")}
              </Link>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-10">
              <Link href="/urunler" className="inline-flex items-center px-8 py-3 bg-[var(--color-primary)] text-white font-semibold rounded-lg hover:bg-[var(--color-primary-dark)] transition-all">
                {t("products.view_all")}
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </Link>
            </div>
      ...
      <section className="bg-[var(--color-primary)] text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/iletisim" className="inline-flex items-center px-10 py-4 bg-white text-[var(--color-primary)] font-bold rounded-lg hover:bg-gray-100 transition-all shadow-lg text-lg">
            {t("cta.button")}
          </Link>
        </div>
      </section>
