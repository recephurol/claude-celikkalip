...
import { getMessages, toggleMessageRead, deleteMessage, ContactMessage } from '../../lib/store';
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex gap-2 shrink-0">
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${msg.isRead ? 'text-gray-400 hover:bg-gray-50' : 'text-green-600 hover:bg-green-50'}`}
                    title={msg.isRead ? 'Okunmadi olarak isaretle' : 'Okundu olarak isaretle'}
                  >
